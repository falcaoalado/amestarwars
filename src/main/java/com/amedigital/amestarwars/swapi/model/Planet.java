package com.amedigital.amestarwars.swapi.model;
...
public class Planet {
	...
	public Planeta planetToPlaneta() {

		Planeta planeta = new Planeta();

		planeta.setNome(this.getName());
		planeta.setClima(this.getClimate());
		planeta.setTerreno(this.getTerrain());
		planeta.setQuantidadeAparicoes(this.getFilms().size());
